...
Django settings for research_planner project.
...
WSGI_APPLICATION = 'research_planner.wsgi.application'
# Database
...
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD')  #Google App password
EMAIL_USE_TLS = True
